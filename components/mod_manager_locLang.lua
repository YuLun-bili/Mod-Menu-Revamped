...
locLangLookup = {
	...
	setting5 = 		{
		...
		"Reset filter when changing mod category",
		"Filter beim Ändern der Mod-Kategorie zurücksetzen",
		"更改模组类别时重置过滤选项",
	...
	setting6 = 		{
		...
		"Fold author list by default",
		"Autorenliste standardmäßig minimieren",
		"默认折叠作者列表",
		"デフォルトで作成者リストを隠す",
	...
	clearModData =		{
		...
		"This mod occupied %s in savegame file. Do you want to clear it?",
		"Diese Mod belegt %s in der Speicherdatei. Möchtest du sie entfernen?",
	...
	clearUnknownData =		{
		...
		"Unknown mods (e.g.: deleted) occupied %s in savegame file in total. Do you want to clear them?",
		"Unbekannte Mods (z.B. gelöschte) belegen %s in der Spielspeicherdatei. Möchtest du diese entfernen?",
	...
	tooltipClearUnknownData ={
		...
		"Clean-up unknown savegame data",
		"Unbekannte Speicherspieldaten aufräumen",
		"清扫未知存档数据",
		"不明なセーブデータをクリーンアップする",
	...
	collectEnabledToColAsk ={
		...
		"Do you want to remove all disabled/other mods from collection at the same time?",
		"Möchtest du alle deaktivierten/anderen Mods aus der Sammlung gleichzeitig entfernen?",
		"你想要同时将已禁用/其它模组从合集中移除吗？",
		"全ての無効なMODを同時にコレクションから削除しますか？",
